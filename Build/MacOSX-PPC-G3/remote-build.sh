...
# 10.3.9 SDK and Apple compilers; the *output* targets Panther/G3.
#
...
#   AA_PPC_PATH   remote directory to sync into (default: ~/aa-ppc-g3-build/AAServer)
#   AA_PPC_PORT   ssh port (default: 22)
#   AA_PPC_MAKE   make binary to invoke remotely (default: auto-detect gmake).
...
REMOTE_PATH="${AA_PPC_PATH:-~/aa-ppc-g3-build/AAServer}"
...
echo "==> Done. Binary at $REMOTE_PATH/Build/MacOSX-PPC-G3/build/AAServer on $AA_PPC_HOST"
